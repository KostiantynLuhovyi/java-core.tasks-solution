 ...
 * <p>
 * Functional interface for the implementation of the calculations on the two varibles.
 * @since 01.02.2017
 */
@FunctionalInterface
public interface CalculableOnTheTwoVariables<T> extends Calculable<T> {
    /**
