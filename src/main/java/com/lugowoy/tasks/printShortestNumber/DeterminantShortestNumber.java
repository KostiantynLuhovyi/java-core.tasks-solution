...
public interface DeterminantShortestNumber<T> {

    int determine(Array<T> array);

    static int determineShortestNumberOfNumbers(Array<Integer> integerArray) {
    ...
    static int determineShortestNumberOfStrings(Array<String> stringsArray) {
        int resultNumber = Integer.MAX_VALUE;
