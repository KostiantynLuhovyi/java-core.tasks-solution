package com.lugowoy.tasks.arrays.locateSnailOnTreeAfterThirtyDays;

import com.lugowoy.tasks.arrays.locateSnailOnTreeAfterThirtyDays.entity.Snail;
import com.lugowoy.tasks.arrays.locateSnailOnTreeAfterThirtyDays.entity.Tree;
import com.lugowoy.tasks.arrays.locateSnailOnTreeAfterThirtyDays.entity.Weather;
import com.lugowoy.tasks.arrays.locateSnailOnTreeAfterThirtyDays.entity.WeatherArray;
import com.lugowoy.tasks.oop.determiningProfitableExchangeOfCurrencyInBank.determine.*;
